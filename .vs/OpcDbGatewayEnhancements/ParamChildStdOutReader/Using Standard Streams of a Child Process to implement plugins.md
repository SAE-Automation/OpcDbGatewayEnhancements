...
*Figure 3 Sequential diagram of receiving unsolicited messages by the OpcDbGateway runtime application from an external entity using a child process started from the custom DLL*
